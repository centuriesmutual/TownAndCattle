  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="tc-reveal-wide mx-auto max-w-3xl text-center lg:mx-0 lg:max-w-2xl lg:text-left">
          ...
          <p className="mt-5 text-base leading-relaxed text-wf-muted sm:text-lg">
            ...
            <strong className="font-semibold text-wf-ink">Choice</strong> is
            high quality and widely loved for everyday cooking;{" "}
        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:gap-6">
          {benefits.map((b) => (
            <div
              key={b.title}
              className="tc-reveal-card rounded-2xl border border-wf-border bg-wf-white p-6 shadow-sm sm:p-7"
            >
