  ...
  return (
    ...
    >
      <Image
        ...
        sizes="100vw"
      />
      {/* Readability: strong left column for headline; lighter right for photo */}
      <div
      ...
      <div className="relative z-[1] mx-auto flex min-h-[min(92vh,56rem)] w-full max-w-7xl flex-col justify-center px-4 py-28 sm:px-6 sm:py-24 lg:px-10 lg:py-20">
