...
export function OurTownshipContent() {
  return (
    <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
      <div className="grid gap-12 lg:grid-cols-2 lg:items-start lg:gap-16">
        <div>
          ...
          <p className="mt-4 text-base leading-relaxed text-wf-muted">
            Whether you run a Hill Country cow-calf program, a regional packing
            partnership, or a direct-to-consumer expansion of an existing USDA
            facility, we align onboarding to how you already document grades
            and lots.
          </p>
          ...
          <ul
            id="township-resources"
            className="mt-10 space-y-3 border-t border-wf-border pt-8 text-sm text-wf-muted"
          >
            <li>
              <Link
                href="/#contact"
      ...
      >
        {pillars.map((p) => (
          <article
            key={p.title}
            className="rounded-2xl border border-wf-border bg-wf-sage/50 p-6 sm:p-8"
          >
      ...
      <div
        id="township-cta"
        className="mt-14 rounded-2xl bg-wf-ink px-6 py-10 text-center sm:px-10 sm:py-12"
      >
